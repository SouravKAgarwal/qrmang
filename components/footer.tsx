...
const Footer = () => {
  return (
    <footer className="w-full border-t py-8">
      <div className="mx-auto grid w-full max-w-5xl grid-cols-1 gap-8 px-6 md:grid-cols-3 md:px-0">
        <div>
          <h3 className="mb-4 text-xl font-bold">qrmang</h3>
          <p className="text-sm">
            Create, manage, and share QR codes seamlessly with qrmang.
          </p>
        </div>
        ...
        <div>
          ...
          <p className="mb-2 text-sm">
            Email: <a href="mailto:support@qrmang.com">support@qrmang.com</a>
          </p>
