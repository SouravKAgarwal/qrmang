...
import ShopsDropdownMenu from "@/components/business/business-dropdown";
...
export default async function Home() {
  ...
  const business = await db
    .select()
    .from(businesses)
    .where(eq(businesses.ownerId, session?.user?.id as string));
      ...
      <div className="flex-1 overflow-auto py-16">
        <div className="mx-auto max-w-6xl px-4">
          <div className="flex items-center justify-between gap-3 border-b border-gray-200 dark:border-gray-800">
            <h1 className="mb-4 mt-8 text-2xl font-medium">Get Started</h1>
            <ShopsDropdownMenu businesses={business} />
          </div>
          <div className="mt-6">
            ...
            <div className="mt-16 grid gap-8 md:grid-cols-3">
              {[
                ...
                },
                {
                  ...
                  description:
                    "Track visitor check-ins for safety and analytics",
                },
                {
